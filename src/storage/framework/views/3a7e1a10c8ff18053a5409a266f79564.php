...
<div class="bg-white rounded-lg shadow p-6 max-w-2xl mx-auto">
    ...
    <form method="POST" action="<?php echo e(route('users.store')); ?>">
        ...
        <div class="mb-4">
            ...
            <input type="email" name="email" value="<?php echo e(old('email')); ?>" class="w-full px-3 py-2 border rounded-lg" required>
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="phone" value="<?php echo e(old('phone')); ?>" class="w-full px-3 py-2 border rounded-lg">
        </div>
        
        <div class="mb-4">
            <label class="block text-gray-700 text-sm font-bold mb-2">Address</label>
            <textarea name="address" class="w-full px-3 py-2 border rounded-lg" rows="3"><?php echo e(old('address')); ?></textarea>
        </div>
